...
1. Fork `the repository <https://github.com/twaclaw/test1>`_ and clone the fork.
...
When `reporting a bug <https://github.com/twaclaw/test1/issues>`_
please include:
...
`Github <https://github.com/twaclaw/test1/issues>`_. If you are proposing a feature:
